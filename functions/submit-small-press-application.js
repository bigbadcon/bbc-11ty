    ...
    if (event.httpMethod === 'POST') {
        ...
        try {
            ...
            try {
                ...
                if (res.status === 200) {
                    console.log(`small-press-vendor role added for ${eventBody.userDisplayName} userId:${eventBody.userId}`)
                    ...
                    try {
                        ...
                        console.log(`eventId: ${eventBody.eventId} booked for ${eventBody.userDisplayName} userId:${eventBody.userId}`)
                    } catch (err) {
                        console.log(`eventId: ${eventBody.eventId} failed to book for ${eventBody.userDisplayName} userId:${eventBody.userId}`)
                    }
